...
d = { 'settings': { 'branch': 'main',
                ...
                'doc_host': 'https://ljagged.github.io',
                'git_url': 'https://github.com/ljagged/nbdev-hello-world',
                'lib_path': 'nbdev_hello_world'},
  'syms': { 'nbdev_hello_world.core': {'nbdev_hello_world.core.foo': ('core.html#foo', 'nbdev_hello_world/core.py')},
            'nbdev_hello_world.nbdev_hello_world': { 'nbdev_hello_world.nbdev_hello_world.say_hello': ( 'core.html#say_hello',
